...
REAL(EB) :: DIAMETER, GAMMA_D,AGE,INITIAL_TEMPERATURE,HEAT_OF_COMBUSTION, &
	    ...
	    A_COEFF_DRAG_NDR,B_COEFF_DRAG_NDR,N_COEFF_DRAG_NDR ! Martin add A_COEFF,B_COEFF, N_COEFF that will be used in the NDR_DRAG_REDUCTION
...
READ_PART_LOOP: DO N=1,N_LAGRANGIAN_CLASSES
   ...
   LPC%A_COEFF_DRAG_NDR = A_COEFF_DRAG_NDR !Martin
   LPC%B_COEFF_DRAG_NDR = B_COEFF_DRAG_NDR !Martin
   LPC%N_COEFF_DRAG_NDR = N_COEFF_DRAG_NDR !Martin
...
! Martin add Drag_reduction_law
   SELECT CASE (DRAG_REDUCTION_LAW)
      ...
      CASE('USER_REDUCTION')
         ...
         ENDIF
      CASE('NDR_REDUCTION')
         LPC%DRAG_REDUCTION_LAW = NDR_DRAG_REDUCTION
         IF (A_COEFF_DRAG_NDR<0._EB .OR. B_COEFF_DRAG_NDR<0._EB .OR. N_COEFF_DRAG_NDR<0._EB) THEN
            WRITE(MESSAGE,'(A,I0,A)') 'ERROR: PART line ',N,&
                                      '.  For NDR REDUCTION, i.e. Novel Drag Reduction drag reduction law, the coeff A, B and N must be positive.',N,&
...
A_COEFF_DRAG_NDR         = -1._EB ! Martin add A_COEFF for ndr defined reduction law
B_COEFF_DRAG_NDR         = -1._EB ! Martin add B_COEFF for ndr defined reduction law
N_COEFF_DRAG_NDR         = -1._EB ! Martin add N_COEFF for ndr defined reduction law
