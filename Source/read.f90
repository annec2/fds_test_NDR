...
REAL(EB) :: DIAMETER, GAMMA_D,AGE,INITIAL_TEMPERATURE,INITIAL_INNER_TEMPERATURE,HEAT_OF_COMBUSTION, & !Martin
...
CHARACTER(LABEL_LENGTH) :: SPEC_ID,DEVC_ID,CTRL_ID,QUANTITIES(1:10),QUANTITIES_SPEC_ID(1:10),SURF_ID,DRAG_LAW,PROP_ID,PART_HEAT_TRANSFER_MODEL, & ! Martin
...
NAMELIST /PART/ ADHERE_TO_SOLID,AGE,BREAKUP,BREAKUP_CNF_RAMP_ID,BREAKUP_DISTRIBUTION,BREAKUP_GAMMA_D,BREAKUP_RATIO,&
                ...
                DEVC_ID,DIAMETER,DISTRIBUTION,DRAG_COEFFICIENT,DRAG_LAW,PART_HEAT_TRANSFER_MODEL,& ! Martin
                ...
                HORIZONTAL_VELOCITY,ID,INITIAL_TEMPERATURE,INITIAL_INNER_TEMPERATURE,KILL_DIAMETER,MASSLESS,& !Martin
...
READ_PART_LOOP: DO N=1,N_LAGRANGIAN_CLASSES
   ...
   LPC%TMP_INNER_INITIAL		= INITIAL_INNER_TEMPERATURE + TMPM !Martin
...
INITIAL_INNER_TEMPERATURE= -TMPM -1._EB !Martin
