...
TYPE LAGRANGIAN_PARTICLE_CLASS_TYPE
   ...
   REAL(EB) :: TMP_INNER_INITIAL	  !< Initial inner layer temperature (K) of the particles for the Two-Zone Model ! Martin
...
INTEGER, PARAMETER :: N_ONE_D_SCALAR_REALS=32 !Martin : was 26
...
!Martin
   ...
   REAL(EB) :: H_V		     !< output quantity for analysis purpose cfr data.f90 and dump.f90 (J/kg)
   REAL(EB) :: M_DOT		     !< output quantity for analysis purpose cfr data.f90 and dump.f90 (kg/s)
