...
!Martin 
OUTPUT_QUANTITY(552)%NAME = 'OUTER LAYER TEMPERATURE'
OUTPUT_QUANTITY(552)%UNITS = 'C'
OUTPUT_QUANTITY(552)%SHORT_NAME = 'temp_out'
!Martin
OUTPUT_QUANTITY(553)%NAME = 'INNER LAYER TEMPERATURE'
OUTPUT_QUANTITY(553)%UNITS = 'C'
OUTPUT_QUANTITY(553)%SHORT_NAME = 'temp_in'
!Martin
OUTPUT_QUANTITY(554)%NAME = 'OUTER LAYER DEPTH'
OUTPUT_QUANTITY(554)%UNITS = 'mu-m'
OUTPUT_QUANTITY(554)%SHORT_NAME = 'delta_out'
!Martin
OUTPUT_QUANTITY(555)%NAME = 'INNER LAYER RADIUS'
OUTPUT_QUANTITY(555)%UNITS = 'mu-m'
OUTPUT_QUANTITY(555)%SHORT_NAME = 'r_in'
!Martin L_v
OUTPUT_QUANTITY(556)%NAME = 'LATENT HEAT OF VAPORIZATION'
OUTPUT_QUANTITY(556)%UNITS = 'J/kg'
OUTPUT_QUANTITY(556)%SHORT_NAME = 'L_v'
!Martin m_dot
OUTPUT_QUANTITY(557)%NAME = 'M_DOT'
OUTPUT_QUANTITY(557)%UNITS = 'kg/s'
OUTPUT_QUANTITY(557)%SHORT_NAME = 'm_dot'
...
!Martin Martin L_V 557 was 555 before
OUTPUT_QUANTITY(552:557)%PART_APPROPRIATE = .TRUE.
OUTPUT_QUANTITY(552:557)%SLCF_APPROPRIATE = .FALSE.
OUTPUT_QUANTITY(552:557)%DEVC_APPROPRIATE = .TRUE.
