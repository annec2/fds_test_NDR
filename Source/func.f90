...
SF%ONE_D_REALS_ARRAY_SIZE(20) = SF%N_CELLS_MAX+2             ! TMP_INNER !Martin

SF%ONE_D_INTEGERS_ARRAY_SIZE(1) = SF%N_LAYERS                ! N_LAYER_CELLS

! Update last array size index also to the sum below

SF%N_ONE_D_STORAGE_REALS    = N_ONE_D_SCALAR_REALS    + SUM(SF%ONE_D_REALS_ARRAY_SIZE(1:20))!Martin
...
IF (.NOT.ALREADY_ALLOCATED) THEN
   ...
   IF (ALLOCATED(ONE_D%TMP_INNER)) DEALLOCATE(ONE_D%TMP_INNER) !Martin
   ALLOCATE(ONE_D%TMP_INNER(0:SF%ONE_D_REALS_ARRAY_SIZE(20)-1)) !Martin
...
I1 = I2+1 ; I2 = I1 + SF%ONE_D_REALS_ARRAY_SIZE(20) - 1 !Martin
CALL EQUATE(OS%REALS(I1:I2,STORAGE_INDEX) , ONE_D%TMP_INNER(0:I2-I1) , UNPACK_IT) !Martin
